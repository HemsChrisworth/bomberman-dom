...
func ReplyCreateGroup(app *application.Application, currConnection *wsconnection.UsersConnection, message webmodel.WSMessage) (any, error) {
...
func ReplyGroupMembers(app *application.Application, currConnection *wsconnection.UsersConnection, message webmodel.WSMessage) (any, error) {
	...
	if err != nil {
		return nil, currConnection.WSError(app, "getting list of members from DB failed", err)
	}
...
func ReplyUserGroups(app *application.Application, currConnection *wsconnection.UsersConnection, message webmodel.WSMessage) (any, error) {
...
func ReplyGetGroupProfile(app *application.Application, currConnection *wsconnection.UsersConnection, message webmodel.WSMessage) (any, error) {
	groupID, err := parse.PayloadToString(message.Payload)
	if err != nil {
		return nil, currConnection.WSError(app, fmt.Sprintf("Invalid payload for a new group: %s", message.Payload), err)
	}
...
func ReplyLeaveGroup(app *application.Application, currConnection *wsconnection.UsersConnection, message webmodel.WSMessage) (any, error) {
	groupID, err := parse.PayloadToString(message.Payload)
	if err != nil {
		return nil, currConnection.WSError(app, fmt.Sprintf("Invalid payload for a new group: %s", message.Payload), err)
	}
	...
	if err != nil {
		return nil, currConnection.WSError(app, fmt.Sprintf("Could not get group from db with id: %s", message.Payload), err)
	}
	return "", nil
}
